 ...
 * @access   public
 */
 // validamos si la funcion ya existe registrada en db de woordpress
    ...
    function serialize($debug = 0)
    {
        ...
        if (count($this->ports) >= 1) {
            foreach ($this->ports as $pName => $attrs) {
                ...
                //$xml .= "\n" . '    <soap:address location="http://www3.ubilop.com:8082/FACTWS/IntegraCF.asmx"/>';
                $xml .= "\n" . '  </port>';
            }
        }
        $xml .= "\n" . '</service>';
...
class nusoap_client extends nusoap_base
{
    ...
    var $endpoint;
    var $forceEndpoint = UBILOP_WS_CONFIG ;        // overrides WSDL endpoint
    var $proxyhost = '';
    var $proxyport = '';
    var $proxyusername = '';
    var $proxypassword = '';
